...
<form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>?action=Enregistrement"style="border:1px solid silver; border-radius: 10px; box-shadow:6px 6px 6px grey"" >
