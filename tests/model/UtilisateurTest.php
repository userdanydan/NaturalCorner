...
class UtilisateurTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
    	$this->utilisateurDuTest = new Utilisateur("Daniel", "Dan", "DanyDan", "Motdepasse1", 
    			"truc@troc.tr", "rue des petites fleurs 5", "1070", "Anderlecht",
    ...
    {
        $this->assertEquals("rue des petites fleurs 5 1070 Anderlecht", 
                $this->utilisateurDuTest->getAdressePhysique().' '.
                $this->utilisateurDuTest->getCodePostal().' '.
                $this->utilisateurDuTest->getLocalite(),
    ...
    public function testToString()
    {
    	...
    	$this->assertEquals('{"id"="0","prenom"="Daniel","nom"="Dan","pass"="Motdepasse1","adresseMail"="truc@troc.tr","adressePhysique"="rue des petites fleurs 5","codePostal"="1070","localite"="Anderlecht"'.
